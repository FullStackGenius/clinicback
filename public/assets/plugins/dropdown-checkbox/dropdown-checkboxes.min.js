    ...
    var dropdownMethods = {
        init: function (options) {
            ...
            dropdowns.each(function (i) {
                ...
                dropdown.append($("<input/>", { type: "hidden", class: "hidden-input", name: dropdown.data("name"), value: "" }));
                dropdown.find("input[type=checkbox]").click(function () {
                    //$(this).dropdownCheckboxes("eval");
                });
                dropdown.find("button.save").click(function (e) {
					...
					updateModuleListFilter(module, values.join(","));
                });
