                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-end">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Learn How To Hire</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary card-outline mb-4">
                            ...
                            <div class="card-header">
                                <div class="card-title">Learn How To Hire</div>
                            </div>
                            <!--end::Header-->
                            <!--begin::Form-->
                            @if (session('success'))
                            ...
                            @endif
                            <form action="{{ route('learn-how-to-hire.store') }}" method="post"
