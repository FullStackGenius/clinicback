            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box">
                  ...
                  <div class="info-box-content" onclick="window.location.href='{{ route('freelancer.index')}}';" style="cursor: pointer;">
              ...
              <!-- /.col -->
              <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box" onclick="window.location.href='{{ route('client.index')}}';" style="cursor: pointer;">
              ...
              <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box" onclick="window.location.href='{{ route('jobs.index')}}';" style="cursor: pointer;">
