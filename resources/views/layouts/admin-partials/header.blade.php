    ...
    <ul class="navbar-nav ms-auto">
      ...
      <li class="nav-item dropdown user-menu">
        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
          <img src="{{ Auth::user()->profile_image_path }}" class="user-image img-circle shadow" alt="User Image">
          {{-- <img src="{{ asset('storage/user-image/' . Auth::user()->profile_image) }}" class="user-image img-circle shadow" alt="User Image"> --}}
          <span class="d-none d-md-inline">{{ ucfirst(Auth::user()->name) }}</span>
        </a>
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
          <!-- User image -->
          <li class="user-header bg-primary">
            <img src="{{ Auth::user()->profile_image_path }}" class="img-circle shadow" alt="User Image">
