    ...
    <main class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <div class="fs-3">Resource Category</div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        <div class="card mb-12">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h3 class="card-title">Resource category </h3> <a href="{{ route('resource-category.create') }}"
                                    class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i>Resource category</a>
                            </div>
                            @if (session('success'))
                                        ...
                                        @foreach ($categorys as $category)
                                            <tr class="align-middle">
                                                <td>
                                                    ...
                                                    @php
                                                        $perPage = $categorys->perPage(); // Number of items per page
                                                        $currentPage = $categorys->currentPage(); // Current page number
                                                ...
                                                <td style="display: flex;column-gap: 5px;"><a
                                                        href="{{ route('resource-category.edit', $category->id) }}"
                                                        class="btn btn-primary btn-sm mb-2"><i class="fa fa-edit"></i> Edit</a>
                                                    <form action="{{ route('category.destroy', $category->id) }}"
                                                        method="POST" id="submitDeleteForm{{ $category->id }}">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button data-token="{{ $category->id }}"
