                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary card-outline mb-4">
                            ...
                            <div class="card-header">
                                <div class="card-title">Freelancer</div>
                            </div>
                            <!--end::Header-->
                            <!--begin::Form-->
                            ...
                            <form action="{{ route('freelancer.update', $user->id) }}" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number"   step="0.1" min="0" max="5" class="form-control" id="star_rating" name="star_rating"
                                            value="{{ @$user->star_rating }}" />
                                        @error('star_rating')
                                            <div class="error" style="color: red;">{{ $message }}</div>
                                        @enderror
                                    </div>
